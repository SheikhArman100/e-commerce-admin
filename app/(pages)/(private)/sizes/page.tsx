...
export default function SizesPage() {
  // Get sizes data for potential stats or loading states
  const { data: sizesData, isLoading } = useSizes({
    page: 1,
    limit: 10
  });
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Manage product sizes and dimensions</p>
        </div>

        <div className="flex items-center gap-2">
          <Link href="/sizes/create-size">
            <Button size="md">
